...
@section('contents')
    ...
    <div class="main-panel">
        <div class="content-wrapper">
                                    ...
                                    <div class="col-8 col-sm-12 col-xl-8 my-auto">
                                        <div class="d-flex d-sm-block d-md-flex align-items-center">
                                            ...
                                            <p class="text-success ms-2 mb-0 font-weight-medium"><span
                                                    style="color: {{ $color }};">&nbsp{{ number_format($percentageNew, 1) }}%</span>
                                            </p>
                                        </div>
                                        <h6 class="text-muted font-weight-normal">
                                            Gesamtzahl {{number_format(\App\Models\handys::where('status' , 'Neu')->sum('amount'))}}
                                            Stk.</h6>
                                    </div>
                                    ...
                                    <div class="col-8 col-sm-12 col-xl-8 my-auto">
                                        <div class="d-flex d-sm-block d-md-flex align-items-center">
                                            ...
                                            <h3 class="mb-0">{{ number_format($total_used, 2) }} €</h3>
                                                ...
                                                ?>
                                            <p class="text-or ms-2 mb-0 font-weight-medium"><span
                                                    style="color: {{ $color }};">&nbsp{{ number_format($percentageUsed, 1) }}%</span>
                                            </p>
                                        </div>
                                        <h6 class="text-muted font-weight-normal">
                                            Gesamtzahl {{number_format(\App\Models\handys::where('status' , 'Gebraucht')->sum('amount'))}}
                                            Stk.</h6>
                                    </div>
                                    <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-8 col-sm-12 col-xl-8 my-auto">
                                        <div class="d-flex d-sm-block d-md-flex align-items-center">
                                            <h3 class="mb-0">{{number_format(\App\Models\Accessories::sum('price') , 2)}}
                                                €</h3>
                                        </div>
                                        <h6 class="text-muted font-weight-normal">
                                            Gesamtzahl {{number_format(\App\Models\Accessories::count())}} Stk.</h6>
                                    </div>
                                    <div class="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                    ...
                    <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="col-9">
                                        <div class="d-flex align-items-center align-self-start">
                                            ...
                                            <h4 class="mb-0">{{ number_format($totalNewSam, 2) }} €</h4>
                                                ...
                                                ?>
                                            <p class="text-success ms-2 mb-0 font-weight-medium"><span
                                                    style="color: {{ $color }};">&nbsp{{ number_format($percentageNewSam, 1) }}%</span>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                ...
                                <h6 class="text-muted font-weight-normal">
                                    Gesamtzahl {{number_format(\App\Models\handys::where([['status' , 'Neu'] , ['section_name' , 'samsung']])->sum('amount'))}}
                                    Stk.</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="col-9">
                                        <div class="d-flex align-items-center align-self-start">
                                            ...
                                            <h4 class="mb-0">{{ number_format($totalUsedSam, 2) }} €</h4>
                                                ...
                                                ?>
                                            <p class="text-success ms-2 mb-0 font-weight-medium"><span
                                                    style="color: {{ $color }};">&nbsp{{ number_format($percentageUsedSam, 1) }}%</span>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                ...
                                <h6 class="text-muted font-weight-normal">
                                    Gesamtzahl {{number_format(\App\Models\handys::where([['status' , 'Gebraucht'] , ['section_name' , 'samsung']])->sum('amount'))}}
                                    Stk.</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="col-9">
                                        <div class="d-flex align-items-center align-self-start">
                                            ...
                                            <h4 class="mb-0">{{ number_format($totalNewApl, 2) }} €</h4>
                                                ...
                                                ?>
                                            <p class="text-success ms-2 mb-0 font-weight-medium"><span
                                                    style="color: {{ $color }};">&nbsp{{ number_format($percentageNewApl, 1) }}%</span>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                ...
                                <h6 class="text-muted font-weight-normal">
                                    Gesamtzahl {{number_format(\App\Models\handys::where([['status' , 'Neu'] , ['section_name' , 'apple']])->sum('amount'))}}
                                    Stk.</h6>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-sm-6 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="col-9">
                                        <div class="d-flex align-items-center align-self-start">
                                            ...
                                            <h4 class="mb-0">{{ number_format($totalUsedApl, 2) }} €</h4>
                                                ...
                                                ?>
                                            <p class="text-success ms-2 mb-0 font-weight-medium"><span
                                                    style="color: {{ $color }};">&nbsp{{ number_format($percentageUsedApl, 1) }}%</span>
                                            </p>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                ...
                                <h6 class="text-muted font-weight-normal">
                                    Gesamtzahl {{number_format(\App\Models\handys::where([['status' , 'Gebraucht'] , ['section_name' , 'apple']])->sum('amount'))}}
                                    Stk.</h6>
                            </div>
                        </div>
                    </div>
            ...
            <!-- Modal for Cookies -->
            <div class="modal fade" id="cookieModalAdmin" tabindex="-1" aria-labelledby="cookieModalAdminLabel"
                 aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>
                                Wir verwenden Cookies, um Ihre Erfahrung auf unserer Website zu verbessern und relevante
                                Inhalte anzuzeigen.
                            ...
                            <div class="modal-footer">
                                <button id="acceptCookiesAdmin" type="submit"
                                        class="btn btn-rounded btn-outline-primary">Akzeptieren
                                </button>
                                <button type="button" class="btn btn-rounded btn-outline-secondary"
                                        data-dismiss="modal">Ablehnen
                                </button>
                            </div>
                        </div>
                    </div>
