                ...
                <div class="col-lg-7 mx-auto text-white">
                    <div class="row align-items-center d-flex flex-row">
                        ...
                        <div class="col-lg-6 error-page-divider text-lg-left pl-lg-4">
                            ...
                            <h3 class="font-weight-light">Der Benutzer verfügt nicht über die richtigen
                                Berechtigungen!</h3>
                        </div>
                    </div>
                    <div class="row mt-5">
                    ...
                    <div class="row mt-5">
                        <div class="col-12 mt-xl-2">
                            <div class="footer-copyrights text-center top-separator ins-md"
                                ...
                                <a href="https://www.louioklaa.com/" style="font-weight: bolder; color: #008C3C">Loui
                                    Oklaa</a> Alle Rechte vorbehalten.
                                <a style="color: #008C3C" href="https://github.com/LouiOklaa"
                                   class="mdi mdi-github-circle"></a>
                                <a style="color: #008C3C" href="https://www.facebook.com/loui.oklaa/"
                                   class="mdi mdi-facebook"></a>
                                <a style="color: #008C3C" href="https://www.linkedin.com/in/loui-oklaa/"
                                   class="mdi mdi-linkedin"></a>
                                <a style="color: #008C3C" href="https://www.instagram.com/loui_oklaa/"
                                   class="mdi mdi-instagram"></a>
                                <a style="color: #008C3C" href="https://wa.me/+4917670352663"
                                   class="mdi mdi-whatsapp"></a>
                                <a style="color: #008C3C" href="https://x.com/loui_oklaa">
                                    <svg style="margin-bottom: 8px; color: #008C3C" xmlns="http://www.w3.org/2000/svg"
