    ...
    <section class="content-section">
        <div class="container">
            <div class="section-head text-center container-md">
                <h2 class="section-title text-upper text-lg" data-inview-showup="showup-translate-right">Warum wählen
                    Sie uns ?</h2>
...
<section class="with-bg solid-section">
    <div class="fix-image-wrap" data-image-src="{{url('/Attachments/Home_Page/' .$information->img4)}}"
    ...
    <div class="container text-center">
        <div class="section-head text-center container-md">
            ...
            <p data-inview-showup="showup-translate-left">Ein einfacher und effektiver Weg, um Ihr Gerät reparieren zu
                lassen.</p>
        </div>
...
<section class="muted-bg solid-section">
    <div class="container">
        <div class="section-head text-center container-md">
            ...
            <p data-inview-showup="showup-translate-left">Wir bieten die neuesten Smartphones auf dem Markt an.
                Entdecken Sie moderne Handys mit fortschrittlicher Technologie und innovativen Funktionen.</p>
        </div>
        <div class="row cols-md rows-md">
            @foreach($handys->take(6) as $one)
                <div class="md-col-4 sm-col-6">
                    <div class="item" data-inview-showup="showup-translate-up">
                        <a href="{{asset( 'Attachments/Handys/' . $one->image)}}" class="block-link text-center">
                            <span class="image-wrap"><img class="image"
                                                          src="{{url('/Attachments/Handys/' .$one->image)}}"
                                                          alt=""/></span>
                            <span class="hover">
                                    ...
                                    @if($one->note != 0)
                                        ...
                                        @if(strlen($note) > $maxLength)
                                            ...
                                            <a href="javascript:void(0)" data-bs-toggle="modal"
                                               data-bs-target="#noteModalMobiles{{ $one->id }}" style="color: #CA5098;">Mehr
                                                erfahren</a>
                                        @else
                                            {{ $note }}
                                        @endif
                ...
                <!-- Modal -->
                <div class="modal fade" id="noteModalMobiles{{ $one->id }}" tabindex="-1"
                     aria-labelledby="noteModalMobiles{{ $one->id }}" aria-hidden="true">
        ...
        <div class="text-center shift-xl">
            <a class="btn text-upper" href="{{ route('all_mobiles') }}" data-inview-showup="showup-translate-up"><i
                    class="fas fa-th-large" aria-hidden="true"></i>&nbsp;&nbsp;Alle Handys anzeigen</a>
        </div>
    </div>
</section>
<section class="main-bg" data-inview-showup="showup-translate-up">
    <div class="container">
        <div class="contact-table only-xs-text-center">
            <div class="contact-icon"><a href="{{$information->facebook_link}}" style="color: #FFFFFF"
                                         class="fab fa-facebook" aria-hidden="true"></a></div>
            <div class="contact-icon"><a href="{{$information->instagram_link}}" style="color: #FFFFFF"
                                         class="fab fa-instagram" aria-hidden="true"></a></div>
            <div class="contact-icon"><a href="{{$information->tiktok_link}}" style="color: #FFFFFF"
                                         class="fab fa-tiktok" aria-hidden="true"></a></div>
            <div class="contact-content">
                <div class="contact-title">Folgen Sie uns !</div>
                <div class="text-justify only-xs-text-justify-center"> Bleiben Sie informiert und werden Sie Teil
                    unserer Familie. Wir freuen uns, Sie bei uns zu haben !
                </div>
            </div>
        </div>
    </div>
...
<section class="muted-bg solid-section">
    <div class="container">
        <div class="section-head text-center container-md">
            ...
            <p data-inview-showup="showup-translate-left">Wir bieten eine breite Auswahl an Zubehör in bester Qualität
                an.</p>
        </div>
        <div class="row cols-md rows-md">
            @foreach($accessories->take(3) as $one)
                <div class="md-col-4 sm-col-6">
                    <div class="item" data-inview-showup="showup-translate-up">
                        <a href="{{asset( 'Attachments/Accessories/' . $one->image)}}" class="block-link text-center">
                            <span class="image-wrap"><img class="image"
                                                          src="{{url('/Attachments/Accessories/' .$one->image)}}"
                                                          alt=""/></span>
                            <span class="hover">
                                        <span class="hover-show">
                                            <span class="back"></span>
                                ...
                                <b>
                                    @if($one->note != 0)
                                        ...
                                        @if(strlen($note) > $maxLength)
                                            {{ substr($note, 0, $maxLength) }}...
                                            <a href="javascript:void(0)" data-bs-toggle="modal"
                                               data-bs-target="#noteModalAccessories{{ $one->id }}"
                                               style="color: #CA5098;">Mehr erfahren</a>
                                        @else
                                            {{ $note }}
                                        @endif
                                    @else
                ...
                <!-- Modal -->
                <div class="modal fade" id="noteModalAccessories{{ $one->id }}" tabindex="-1"
                     aria-labelledby="noteModalAccessories{{ $one->id }}" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
        ...
        <div class="text-center shift-xl">
            <a class="btn text-upper" href="{{ route('all_accessories') }}" data-inview-showup="showup-translate-up"><i
                    class="fas fa-th-large" aria-hidden="true"></i>&nbsp;&nbsp;Alle Zubehör anzeigen</a>
        </div>
    </div>
</section>
<section class="muted-bg solid-section">
    <div class="container">
        <div class="section-head text-center container-md">
            <h2 class="section-title text-upper text-lg" data-inview-showup="showup-translate-right">
                Dienstleistungen</h2>
            <p data-inview-showup="showup-translate-left">Wir bieten ein umfassendes Angebot an Reparaturdiensten, die
                von einem erfahrenen und spezialisierten Team durchgeführt werden.</p>
        </div>
        <div class="row cols-md rows-md">
            @foreach($services->take(3) as $one)
                <div class="md-col-4 sm-col-6">
                    <div class="item" data-inview-showup="showup-translate-up">
                        <a href="{{asset( 'Attachments/Services/' . $one->image)}}" class="block-link text-center">
                            <span class="image-wrap"><img class="image"
                                                          src="{{url('/Attachments/Services/' .$one->image)}}" alt=""/></span>
                            <span class="hover">
                                        <span class="hover-show">
                                            <span class="back"></span>
                                        </span>
                                ...
                                <b>
                                    @if($one->note != 0)
                                        ...
                                        @if(strlen($note) > $maxLength)
                                            {{ substr($note, 0, $maxLength) }}...
                                            <a href="javascript:void(0)" data-bs-toggle="modal"
                                               data-bs-target="#noteModalServices{{ $one->id }}"
                                               style="color: #CA5098;">Mehr erfahren</a>
                                        @else
                                            {{ $note }}
                                        @endif
                ...
                <!-- Modal -->
                <div class="modal fade" id="noteModalServices{{ $one->id }}" tabindex="-1"
                     aria-labelledby="noteModalServices{{ $one->id }}" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="noteModalServices{{ $one->id }}">Beschreibung</h5>
                                <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                            </div>
                            <div class="modal-body">
        ...
        <div class="text-center shift-xl">
            <a class="btn text-upper" href="{{ route('all_services') }}" data-inview-showup="showup-translate-up"><i
                    class="fas fa-th-large" aria-hidden="true"></i>&nbsp;&nbsp;Alle Dienstleistungen anzeigen</a>
        </div>
    </div>
</section>
...
<section class="content-section">
    <div class="container">
        <div class="section-head text-center container-md">
            <h2 class="section-title text-upper text-lg" data-inview-showup="showup-translate-right">Was die Leute
                sagen</h2>
    ...
    <div class="container">
        <div class="contact-table only-xs-text-center">
            ...
            <div class="contact-content">
                ...
                <div class="text-justify only-xs-text-justify-center">Holen Sie sich Antworten und Ratschläge von den
...
<section class="text-center content-section">
    <div class="container">
        <div class="section-head text-center container-md">
            <h2 class="section-title text-upper text-lg" data-inview-showup="showup-translate-right">Wir sind
                autorisiert</h2>
        </div>
        <div class="owl-carousel" data-inview-showup="showup-translate-up" data-owl-responsive="2;3;4;5"
             data-owl-items="5">
            <div class="item">
        ...
        <div class="info-container">
            <div class="our-info side main-bg">
                <div class="info-block">
                    ...
                    <div class="info-line"><span class="info-icon"><i class="fas fa-phone fa-fw" aria-hidden="true"></i></span>{{$information->phone_number}}
                    </div>
...
<div class="modal fade" id="cookieModal" tabindex="-1" aria-labelledby="cookieModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>
                    Wir verwenden Cookies, um Ihre Erfahrung auf unserer Website zu verbessern und relevante Inhalte
                    anzuzeigen.
                    ...
                    <div class="row cols-md">
                        ...
                        <div class="sm-col-3">
                            ...
                            <div class="cols-list socials cols-sm inline-block">
                                <a href="{{$information->facebook_link}}" class="list-item">&nbsp<i
                                        class="fab fa-facebook-f" aria-hidden="true"></i>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a>
                                <a href="{{$information->instagram_link}}" class="list-item"><i class="fab fa-instagram"
                                                                                                aria-hidden="true"></i>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp</a>
                                <a href="{{$information->tiktok_link}}" class="list-item"><i class="fab fa-tiktok"
        ...
        <div class="footer-copyrights text-center top-separator ins-md">&copy;
            ...
            <a style="color: #CA5098" href="https://x.com/loui_oklaa">
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" fill="currentColor"
                     class="bi bi-twitter-x" viewBox="0 3 20 16">
                    <path
