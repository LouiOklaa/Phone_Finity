                ...
                <div class="row cols-md rows-md">
                    ...
                    <div class="md-col-4"> <!-- تعديل هنا -->
                        <div class="item shop-item shop-item-simple" data-inview-showup="showup-scale">
                            ...
                            <a href="{{asset( 'Attachments/Handys/' . $one->image)}}l" class="item-image responsive-1by1"><img src="{{url('/Attachments/Handys/' .$one->image)}}" alt="" /></a>
                            <div class="item-content shift-md">
                                <div class="item-textes">
                                    <div class="item-title text-upper"><a href="shop-item.html" class="content-link">{{$one->name}}</a></div>
                        ...
                        @else
                            <h1>Keine {{$one->section_name}} zurzeit</h1>
                        @endif
                    @endforeach
                </div>
