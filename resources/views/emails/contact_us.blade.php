    ...
    <section class="content-section">
        <div class="container">
            ...
            <div class="section-head text-center container-md">
                ...
                <h2 class="section-title text-upper text-lg" data-inview-showup="showup-translate-right">Fragen Sie
                    gerne an!</h2>

                <p data-inview-showup="showup-translate-left">Wir sind für Sie da – lassen Sie uns wissen, wie wir
                    helfen können!</p>
            </div>
            <form id="contact-form" action="{{ route('send_email') }}" method="post" class="md-col-8 md-col-offs-2"
                ...
                <div class="field-group">
                    <div class="field-wrap">
                        <input type="email" class="field-control" name="email" id="email" placeholder="E-Mail"
                               required/>
                        <span class="field-back"></span>
                    </div>
                </div>
                <div class="field-group">
                    <div class="field-wrap">
                        <input type="text" class="field-control" name="phone" id="phone" placeholder="Telefonnummer"
                               required/>
                        <span class="field-back"></span>
                    </div>
                </div>
