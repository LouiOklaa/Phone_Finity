                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="edit_modal" >
                                <button style="height: 30px" type="button" class="btn btn-inverse-primary btn-fw embed-responsive btn-rounded" href="#edit_modal" data-id="{{$information->id}}" data-phone_number="{{$information->phone_number}}" data-email="{{$information->email}}" data-address="{{$information->address}}" data-address_link="{{$information->address_link}}" data-facebook_link="{{$information->facebook_link}}" data-instagram_link="{{$information->instagram_link}}" data-tiktok_link="{{$information->tiktok_link}}" data-toggle="modal">Allgemeine Informationen Bearbeiten</button>
                            </div>
                            <br>
                            <form class="forms-sample">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="email" name="email" placeholder="{{$information->email}}" readonly style="background: #2A3038">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="address_link" name="address_link" placeholder="{{$information->address_link}}" readonly style="background: #2A3038">
                                </div>
                                <div class="form-group">
                                    <label for="address">Facebook Link</label>
                                    <input type="text" class="form-control" id="facebook_link" name="facebook_link" placeholder="{{$information->facebook_link}}" readonly style="background: #2A3038">
                                </div>
                                <div class="form-group">
                                    <label for="language">Instagram Link</label>
                                    <input type="text" class="form-control" id="instagram_link" name="instagram_link" placeholder="{{$information->instagram_link}}" readonly style="background: #2A3038">
                                </div>
                                <div class="form-group">
                                ...
                                <form action="allgemeineinformationen/update" method="post" autocomplete="off">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="email" id="email" type="text" style="color: #6C7293">
                                        </div>
                                        <div class="form-group">
                                            <label for="address" class="col-form-label">Adresse :</label>
                                            <input class="form-control" name="address" id="address" type="text" style="color: #6C7293">
                                        </div>
                                        <div class="form-group">
                                            <label for="address_link" class="col-form-label">Adresse Link :</label>
                                            <input class="form-control" name="address_link" id="address_link" type="text" style="color: #6C7293">
                                        </div>
                                        <div class="form-group">
                                            <label for="facebook_link" class="col-form-label">Facebook Link :</label>
                                            <input class="form-control" name="facebook_link" id="facebook_link" type="text" style="color: #6C7293">
                                        </div>
                                        <div class="form-group">
                                            <label for="instagram_link" class="col-form-label">Instagram Link :</label>
                                            <input class="form-control" name="instagram_link" id="instagram_link" type="text" style="color: #6C7293">
                                        </div>
                                        <div class="form-group">
