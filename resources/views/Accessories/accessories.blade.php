                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="add-btn" >
                                <button style="height: 30px" type="button" class="btn btn-inverse-primary btn-fw embed-responsive btn-rounded" href="#add_modal" data-toggle="modal">Produkt Hinzufügen</button>
                            </div>
                                    ...
                                    @foreach($accessories as $one)
                                        <?php $i++?>
                                            <tr>
                                                ...
                                                <td>{{$one->price}} €</td>
                                                <td>{{$one->note}}</td>
                                                <td><a href="{{asset( 'Attachments/Accessories/' . $one->image)}}"><img src="Attachments/Accessories/{{$one->image}}" style="height:30px; width:50px; border-radius: 0;"></a></td>
                                                <td>
                                                    <button class="btn btn-sm btn-rounded btn-inverse-primary" href="#edit_modal" title="Edit" data-id="{{$one->id}}" data-name="{{$one->name}}"  data-section_name="{{$one->section_name}}" data-brand="{{$one->brand}}" data-price="{{$one->price}}" data-note="{{$one->note}}"  data-toggle="modal">Bearbeitens</button>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content modal-content-demo">
                            ...
                            <div class="modal-body">
                                <form action="{{route('zubehör.store')}}" method="post" enctype="multipart/form-data" autocomplete="off">
                                    {{ csrf_field() }}
                ...
                <div class="modal fade" id="edit_modal">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content modal-content-demo">
                            ...
                            <div class="modal-body">
                                <form action="zubehör/update" method="post" enctype="multipart/form-data" autocomplete="off">
                                    {{method_field('patch')}}
                                    {{csrf_field()}}
                                    <div class="modal-body">
                                        <div class="form-group">
