                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="add-btn" >
                                <button style="height: 30px" type="button" class="btn btn-inverse-primary btn-fw embed-responsive btn-rounded" href="#add_modal" data-toggle="modal">Abschnitt Hinzufügen</button>
                            </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content modal-content-demo">
                            ...
                            <div class="modal-body">
                                <form action="{{route('zubehör_abschnitte.store')}}" method="post" autocomplete="off">
                                    {{ csrf_field() }}
                ...
                <div class="modal fade" id="edit_modal">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content modal-content-demo">
                            ...
                            <div class="modal-body">
                                <form action="zubehör_abschnitte/update" method="post" autocomplete="off">
                                    {{method_field('patch')}}
                                    {{csrf_field()}}
                                    <div class="modal-body">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="note">Beschreibung</label>
                                            <textarea class="form-control" id="note" name="note" rows="4" style="color: #6C7293; height:75px"></textarea>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                ...
                <div class="modal fade" id="delete_modal">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content modal-content-demo">
                            ...
                            <div class="modal-body">
                                <form action="zubehör_abschnitte/destroy" method="post" >
                                    {{method_field('delete')}}
                                    {{csrf_field()}}
                                    <div class="modal-body">
                                        <div class="form-group">
