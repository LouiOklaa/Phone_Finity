                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            @can('ZubehörKategorienHinzufügen')
                            <div class="add-btn">
                                ...
                                <table class="table">
                                    ...
                                    @foreach($sections as $one)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$one->note}}</td>
                                            <td>
                                                @can('ZubehörKategorienBearbeiten')
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content modal-content-demo">
                            ...
                            <div class="modal-body">
                                <form action="{{route('zubehör_kategorien.store')}}" method="post" autocomplete="off">
                                    {{ csrf_field() }}
                ...
                <div class="modal fade" id="edit_modal">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content modal-content-demo">
                            ...
                            <div class="modal-body">
                                <form action="zubehör_kategorien/update" method="post" autocomplete="off">
                                    {{method_field('patch')}}
                                    {{csrf_field()}}
                                    <div class="modal-body">
                                        <div class="form-group">
                ...
                <div class="modal fade" id="delete_modal">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content modal-content-demo">
                            ...
                            <div class="modal-body">
                                <form action="zubehör_kategorien/destroy" method="post">
                                    {{method_field('delete')}}
                                    {{csrf_field()}}
                                    <div class="modal-body">
                                        <div class="form-group">
