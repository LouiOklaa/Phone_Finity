...
@section('contents')
    ...
    <div class="container">
        <h1 style="font-size: 35px" class="h1 mb-6 mt-3">
    ...
    <div class="container">
        ...
        <p>Phone Finity<br>{{$information->address}}<br>Telefon : {{$information->phone_number}}
            <br>E-Mail: {{$information->email}}</p>
        <p>Unseren Datenschutzbeauftragten erreichen Sie unter <a href="">datenschutz@phone-finity.de</a> oder unter
        ...
        <p>Wir verwenden auf unserer Seite sog. Session-Cookies, die für Grundfunktionen der Website – wie die
            ...
            nutzerfreundlicher und effektiver zu machen. Es handelt sich dabei um Session-Cookies, welche automatisiert
            gelöscht werden, wenn Sie den Browser schließen. Diese speichern eine sogenannte Session-ID, mit welcher
            sich verschiedene Anfragen Ihres Browsers der gemeinsamen Sitzung zuordnen lassen.</p>
        <p>In diesem Zusammenhang verwenden wir das Consent Management-Tool „Cookiebot“. Die von Ihnen getroffenen
            ...
            als Nachweis der Einwilligung dient. Die mithilfe von Cookiebot erteilten Cookie-Einwilligungen werden für
            einen Zeitraum von 12 Monaten gespeichert.</p>
        <p>Rechtsgrundlage für technisch erforderliche Cookies ist Art. 6 Abs. 1 S. 1 lit. f DS-GVO bzw. bei Abschluss
            von Verträgen über die Internetseite auch Art. 6 Abs. 1 S. 1 lit. b DS-GVO. Technisch nicht erforderliche
            Analyse-Cookies setzen wir nur mit Ihrer Einwilligung nach Art. 6 Abs. 1 S. 1 lit. a DS-GVO ein. Sie können
            ...
            eventuell nicht alle Funktionen dieser Website nutzen können. Ihre Einwilligung in die Verwendung von
            technisch nicht notwendigen Cookies können Sie jederzeit für die Zukunft hier per Mausklick widerrufen.</p>
        ...
        <p>Unsere Webseiten benutzen nach Ihrer Einwilligung den datensparsamen Webanalysedienst Matomo, inklusive
            ...
            unsere Webseite verwenden, werden nur innerhalb der Phone Finity bzw. an unsere Auftragsverarbeiter jedoch
        ...
        <p>Wenn Sie über das Onlineformular oder per E-Mail unsere Firmenpublikationen bestellen, verarbeiten wir Ihre
            ...
            unserer Konzernkommunikation, um Ihnen Informationen über die Phone Finity insbesondere über deren Produkte,
            ...
            Übersendung der Publikationen können Sie jederzeit per E-Mail an <a
                href="">public.relations@phone-finity.de</a> widerrufen und die Zusendung abbestellen.</p>
