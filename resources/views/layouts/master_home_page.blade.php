...
<head>
    ...
    <link href="{{ URL::asset('https://fonts.googleapis.com/css?family=Raleway:400,500,600,700') }}" rel="stylesheet"/>

    <link href="{{ URL::asset('https://fonts.googleapis.com/css?family=Montserrat:300,400,500,600,800,900') }}"
          rel="stylesheet"/>
...
<section class="with-bg solid-section">
    ...
    <div class="fix-image-wrap" data-image-src="{{url('/Attachments/Home_Page/' .$information->img1)}}"
...
<footer class="footer">
    <div class="container only-xs-text-justify-center">
        ...
        <div class="footer-copyrights text-center top-separator ins-md">&copy;
            ...
            <a href="https://www.louioklaa.com/" style="font-weight: bolder;">Loui Oklaa</a> Alle Rechte vorbehalten.
            ...
            <a style="color: #CA5098" href="https://x.com/loui_oklaa">
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" fill="currentColor"
                     class="bi bi-twitter-x" viewBox="0 2 20 16">
                    <path
