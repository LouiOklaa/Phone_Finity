...
<head>
    ...
    <link href="{{ URL::asset('https://fonts.googleapis.com/css?family=Montserrat:300,400,500,600,800,900') }}" rel="stylesheet" />
            ...
            <div class="menu-container menu-row">
                ...
                <div class="menu">
                    <ul class="menu-items">
                        ...
                        <li>
                            <a href="{{route('contact_us')}}">Kontakt</a><span class="toggle-icon"><i class="fas fa-chevron-down" aria-hidden="true"></i></span>
                        </li>
                    </ul>
