...
<head>
    ...
    <link rel="stylesheet"
          href="{{ URL::asset('assets/vendors/bootstrap-datepicker/datetime/bootstrap-datetimepicker.min.css') }}">
    {{--  Progress bar  --}}
...
<div class="container-scroller">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            ...
                            @can('GeräteKategorien')
                                <li class="nav-item"><a class="nav-link" href="/handys_kategorien">Gerätes
                                        Kategorien</a></li>
                            @endcan
                        </ul>
                    </div>
            ...
            @can('Zubehör')
                <li class="nav-item menu-items">
                    <a class="nav-link" data-toggle="collapse" href="#ui-basic-Z" aria-expanded="false"
                       aria-controls="auth">
              <span class="menu-icon">
                    ...
                    <div class="collapse" id="ui-basic-Z">
                        <ul class="nav flex-column sub-menu">
                            ...
                            @can('ZubehörKategorien')
                                <li class="nav-item"><a class="nav-link" href="/zubehör_kategorien">Zubehör
                                        Kategorien</a></li>
                            @endcan
                        </ul>
                    </div>
              ...
              <span class="menu-icon">
                <i class="mdi mdi-library-books"></i>
                    ...
                    <div class="collapse" id="ui-basic-D">
                        <ul class="nav flex-column sub-menu">
                            @can('HandysDienste')
                                <li class="nav-item"><a class="nav-link" href="/dienstleistungen">Dienstleistungen</a>
                                </li>
                                @can('DiensteKategorien')
                                @endcan
                                <li class="nav-item"><a class="nav-link" href="/dienste_kategorien">Dienste
                                        Kategorien</a></li>
                            @endcan
                        </ul>
                    </div>
            ...
            @can('Berichte')
                <li class="nav-item menu-items">
                    <a class="nav-link" data-toggle="collapse" href="#ui-basic-X" aria-expanded="false"
                        ...
                        <li class="nav-item dropdown border-left">
                            ...
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list dropdown-custom"
                                       ...
                                       class="dropdown-item preview-item">
                                        ...
                                        <div class="preview-item-content">
                                            <p class="preview-subject ellipsis mb-1">{{$notification->name}} <i
                                                    ...
                                                    style="font-size: 10px; padding: 2px 5px;">neu</i>
                                            </p>
                                ...
                                @empty
                                    ...
                                    <div class="dropdown-divider"></div>
                                @endforelse
                                <p href="{{route('show_all_messages')}}" class="p-3 mb-0 text-center"><a
                                        class="text-muted"
                    ...
                    <li class="nav-item dropdown border-left">
                        <div class="nav-link nav-itemd-none d-md-flex">
                            <span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img
                                    src="{{URL::asset('assets/images/icons/palestine_flag.png')}}" alt="img"></span>
                        </div>
                    </li>
